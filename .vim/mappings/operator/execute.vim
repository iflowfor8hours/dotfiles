...
"
" nnoremap <silent> gx :<C-u>let b:executeoperatorview = winsaveview() <Bar> set operatorfunc=mappings#operator#execute#<Enter>g@
" xnoremap <silent> gx :<C-u>call mappings#operator#execute#(visualmode())<Enter>
" nnoremap <silent> gxl :<C-u>let b:executeoperatorview = winsaveview() <Bar> set operatorfunc=mappings#operator#execute#<Bar> execute 'normal!' v:count 'g@_'<Enter>
"
" @param {string} type Type of motion.
""
function! mappings#operator#execute#(type) abort
