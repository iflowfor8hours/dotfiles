...
"
" nnoremap <buffer><silent> gf :call ftplugin#javascript#gotofile(expand('<cfile>'))<Enter>
" nnoremap <buffer><silent> <C-w>f :call ftplugin#javascript#gotofile(expand('<cfile>'), 'split')<Enter>
" nnoremap <buffer><silent> <C-w><C-f> :call ftplugin#javascript#gotofile(expand('<cfile>'), 'split')<Enter>
" nnoremap <buffer><silent> <C-w>gf :call ftplugin#javascript#gotofile(expand('<cfile>'), 'tab split')<Enter>
"
...
""
function! ftplugin#javascript#gotofile(fname, ...) abort
	if empty(a:fname)
		return v:false
	endif
